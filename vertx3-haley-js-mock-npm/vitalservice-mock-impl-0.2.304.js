 ...
 * @returns
 */
VitalServiceMockImpl = function(address, type, eventbusURL,  successCB, errorCB, logger) {
...
VitalServiceMockImpl.prototype.newConnection = function(){
	setTimeout(() => {
		this.successCB();
	}, 0);
}
...
if(typeof(module) !== 'undefined') {
	...
	module.exports = {
		...
		VitalServiceWebsocketImpl: VitalServiceMockImpl
	};
